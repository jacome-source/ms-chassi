...
import com.hxchassi.ms.api.request.DummyRequest;
import com.hxchassi.ms.api.response.DummyResponse;
...
public class DummyApi {
	...
	public ResponseEntity<DummyResponse> delete(@RequestParam("parameter") String parameter) {
