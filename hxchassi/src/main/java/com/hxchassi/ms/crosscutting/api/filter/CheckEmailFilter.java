package com.hxchassi.ms.crosscutting.api.filter;
...
/**
 * Filtro para validação de email
 * Utilizado apenas em endpoint específico
 * Configurado em SecurityFilterConfig
 */
public class CheckEmailFilter implements Filter {

	// Verifica se o email passado no header possui formato válido
	@Override
